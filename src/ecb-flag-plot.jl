...
set_default_graphic_size(0.2709cm, 0.2709cm)
...
function plot_ecb_crest(n)
    ...
    if n == 0
        ...
        Compose.fill("white"),fillopacity(0.1),Compose.stroke("black")),
        (context(),
        Compose.rectangle(0,3/4,1,1/4),Compose.rectangle(1/2,1/4,1/2,1/4),
        Compose.stroke("black"),Compose.fill("white")),
        (context(),
        Compose.rectangle(),
